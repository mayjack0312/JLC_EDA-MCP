...
- bundled-gateway aligns only the MCP-relevant Debug hot-reload path from official `pro-api-sdk` v1.6.27 (`npm run debug` / port 59394); SDK project creation, updater, manifest, template, and release tooling are intentionally not mirrored
